...
def simulation(t, e=10):
    ...
    #expected happiness and regret for exlore only
    ...
    #simulates total happiness by looping through
    explore_total = 0
    exploit_total = 0
    eGreedy_total = 0
    for i in range(t):
    ...
    #calculates average total happiness and regret
